...
const addhotel = async(req,res)=>{
    try {
//featch data
        const { hotelName, description, phoneNumber, email, description2, hpDescription,Price } = req.body;
...
console.log("image url",result.secure_url)
  ...
  const addro= await hotel.findOneAndUpdate(
    { hotelName: hotelk }, // Find a document with this condition
    { $push: { rooms: newroom } }, // Add 'Jane Doe' to the 'friends' array
